 ...
 * Test Name: Advanced booking - Verify coping of "Profit Center" to new order (yellow menu)
 * Test Case: https://mediaspectrum.testrail.net/index.php?/tests/view/964455
 */

public class T964455_VerifyProfitCenterCopingToNewOrderYellowMenu extends BaseTest{
    ...
    public void createNewOrderViaYellowMenuTest(){
        PartnersPages.scheduleAdvancedTab().doYellowMenuAction("New Order");
    ...
    public void doNewOrderTest(){
        ...
        newProductData.setProductName("24 Heures");
