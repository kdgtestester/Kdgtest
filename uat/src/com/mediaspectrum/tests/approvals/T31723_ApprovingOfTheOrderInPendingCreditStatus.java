 ...
 */
public class T31723_ApprovingOfTheOrderInPendingCreditStatus extends BaseTest{

    private CustomerData customerData;
    private ProductData productData;
    private AdvancedOrderData advancedOrderData;

    public T31723_ApprovingOfTheOrderInPendingCreditStatus(){
    ...
    public void rejectOrder() {
        ...
        Actions.advancedBookingActions().approveOrder();
        ...
        Assert.assertEquals(Pages.dashboardPage().getOrderStatus(), "(new)Live", "Order status is invalid");
    }
