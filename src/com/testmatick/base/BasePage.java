...
public class BasePage {
	...
	protected By getElementLocator(String webElementName, Object... args) {
        //Ok, my dear friend. All Mediaspectrum scripts works after some delay.
        //That's why we'll wait 2/3 second to give time to inject our their scripts correctly
        try {
            Thread.sleep(666);
    ...
    protected boolean isElementHasAttribute(String attribute, String elementName, Object... args) {
        Boolean result = false;
        try {
            String value = getElement(elementName, args).getAttribute(attribute);
            if (value != null){
                result = true;
            }
        } catch (Exception e) {}
    ...
    protected String getElementCssValue(String message, String attributeName, String elementName, Object... args) {
        Reporter.log(message);
        return this.getElement(elementName, args).getCssValue(attributeName);
    }
    ...
    protected String getInnerHTML(String message, String elementName, Object... args) {
        Reporter.log(message);
        WebElement element = this.getElement(elementName, args);
    ...
    protected void waitForElementNotPresent(String elementName, Object... args) {
        ...
        wait.until(new Function<WebDriver, Object>() {
            ...
            public Object apply(WebDriver webDriver) {
                return !isElementPresent(elementName, args);
            }
        });
    }
    ...
    protected void waitForElementEnable(String elementName, Object... args){
        ...
        webDriverWait.until(new ExpectedCondition<Boolean>() {
            ...
            public Boolean apply(WebDriver webDriver) {
                return !isElementHasAttribute("disabled", elementName, args);
