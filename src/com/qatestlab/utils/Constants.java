...
public class Constants {
    ...
    public static String DEFAULT_ADMIN_LOGIN_PAGE_URL = "https://qa-publicitassales.mediaspectrum.net/webadmin";
    ...
    public static String DEFAULT_SUCCESSFUL_ORDER_ID = "10_9300100027004";
    //temporary
    ...
    public static String DEFAULT_USER_NAME = "QA Central Team";
    public static final String DEFAULT_MAIL_FOLDER = "inbox";
    public static final String DEFAULT_INVOICE_MAIL_SUBJECT = "Notification in asp_artransactions_oms on publi-q-bgp-02.equinix.mediaspectrum.net (QA)";
    ...
    public static final String DEFAULT_INTERNAL_PROVENANCE = "Team 3 Consultas";
}
